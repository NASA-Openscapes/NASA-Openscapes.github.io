...
![](zenodo-openscapes-community.png){width="70%" fig-align="center" fig-alt="screenshot of the Openscapes Community page on Zenodo"}
...
![](zenodo-orcid.png){fig-align="center" width="75%" fig-alt="screenshot showing zenodo record called 3 Approaches for the Year of Open Science with green ID symbol linked with an arrow to a second screenshot showing the ORCID record for that publication"}
