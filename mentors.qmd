...
Our 2025 focus is strengthening NASA networks between DAACs, missions, training programs, and applications, aligned with SPD-41a open science, as we continue support users through developing skills and tools.

2025 goals were determined by Mentors during our Fall 2024 Mentors Retreat.
[Julie TODO in progress]

We will move forward on the following four interleaving goals, with a brief overview of the purpose, outcomes, and process of each. 


*💡 indicates Hackdays occurring, with an [open invite to join!](https://github.com/orgs/NASA-Openscapes/projects/7/views/1)*
...
-   **Process**:💡 Biweekly hackdays and further feature development asyncronously; Continued talks and events to support users and showcase capabilities. 
...
-   **Process**: We lead well-planned, welcoming, user-designed teaching events in a variety of formats including in-person and online (hackathons, workshops, Champions Cohorts, Community Calls, conference sessions); we develop open documentation, slides, and tutorials that are available for reuse and remix; we host a JupyterHub compute space in partnership with 2i2c; we co-develop technical cloud technical infrastructure including scientific software docker images; user access administration; cost reports/tracking; and documentation of user stories. Details and registration will be available in late summer on our [News & Events page](/news.qmd).
...
We meet each week in different formats to move our work forward in different ways. To join us, see details of date-times on our [MainPlanning GitHub Project](https://github.com/orgs/NASA-Openscapes/projects/7/views/3).
