...
1.  **Winter & Spring** We have twice-monthly Cohort Calls, which are planning and learning sessions that currently are semi-structured. We kickoff those calls with about 10 mins of check in and agenda design and then we will move to proposed topics. In alternating weeks, we have Coworking sessions to work on shared goals together, screensharing and often working in the 2i2c JupyterHub and in GitHub. From February-May focused extended Coworking sessions to be [Cookbook Hackdays](https://github.com/nasa-openscapes/earthdata-cloud-cookbook#hackdays). Mentors collaborated leading workshops and talks. 
