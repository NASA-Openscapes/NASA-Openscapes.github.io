...
-   **Champions Cohort** (Fall 2025)
    ...
    -   **Purpose**: supporting users using NASA Earthdata from multiple data centers, taught and supported by Mentors who get to understand user needs deeply and co-develop solutions
...
-   **`earthaccess` python library**
    ...
    -   **Process**:
        ...
        -   💡 Further development of earthaccess Integrating virtualizarr Testing on Cloud OPeNDAP-enabled collections (dmrpp compliance/consistency)
...
-   **Earthdata Cloud Cookbook** 💡Cookbook Hackdays - DevSeed contributions from VEDA What is ESDIS thinking about for sharing cloud resources on the unified site? How can Openscapes assist? Does it need to be cloud-specific? Can it just be Earthdata specific?
...
### CalendarMentor Calls, Coworking, and Hackdays

The expected time commitment is 3 days/month per year (and this ebbs and flows with your deadlines).

We meet each week to move our work forward in different ways. Coworking sessions & hackdays are open to anyone to join; see our [MainPlanning GitHub Project](https://github.com/orgs/NASA-Openscapes/projects/7/views/3).

-   biweekly Mentor Calls for planning, sharing, and learning;
-   biweekly Hackdays and Coworking for working synchronously and screensharing
