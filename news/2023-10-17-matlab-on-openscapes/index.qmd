...
![](matlab-launch.png){width="75%" fig-alt="JupyterHub interface with folders listing on left and launcher window on right including 3 rows of icons. Top row inludes MATLAB launcher"}
...
![](matlab-map.png){fig-alt="Map showing sea surface temperature in yellow, green, blue. Heading 'sea surface temperature [kelvin]'; x-axis from 24 to 44; y-axis from -80 to -50"}
